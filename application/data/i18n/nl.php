...
$translationTable = array(
    ...
    "'%value%' does not fit the date format '%readableFormat%'" => "'%value%' past niet in het formaat '%readableFormat%'",
    ...
    "'%value%' is not greater than or equal to '%min%'" => "'%value%' moet groter dan of gelijk aan '%min%' zijn",
    ...
    "'%value%' is not less than or equal to '%max%'" => "'%value%' moet kleiner dan of gelijk aan '%max%' zijn",
