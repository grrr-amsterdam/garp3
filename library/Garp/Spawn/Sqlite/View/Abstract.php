<?php
/**
 * A representation of a Sqlite view that includes the labels of related hasOne and belongsTo records.
 *
 * @package Garp_Spawn_Sqlite_View
 * @author  Harmen Janssen <harmen@grrr.nl>
 */
abstract class Garp_Spawn_Sqlite_View_Abstract implements Garp_Spawn_Sqlite_View_Protocol {
    /**
