...
class Garp_Spawn_Php_Model_BindingBase extends Garp_Spawn_Php_Model_Abstract {
     ...
     * @return array
     */
    protected function _getSingleRelationParams(int $index): array {
        return [
            'model' => $index
                ? $this->getModel()->id
            ...
            'column' => $this->_getRelationColumnName($rel['alias'], $index + 1)
        ];
    }
    ...
    protected function _getBothRelationParams(): array {
        $rels = [
