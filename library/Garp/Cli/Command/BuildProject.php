...
class Garp_Cli_Command_BuildProject extends Garp_Cli_Command {
	 ...
	 * @var String
	 */
	const GARP3_REPO = 'https://svn.grrr.nl/garp3/code/trunk/garp';
	...
	public function main(array $args = array()) {
		if (empty($args[1])) {
			...
			Garp_Cli::errorOut('Usage: php garp.php BuildProject <projectname>');
		} else {
			$projectName = $args[1];
	...
	protected function _createSymlinks() {
		...
		passthru('ln -s ../../garp/application/modules/garp application/modules/g');
		passthru('svn add application/modules/g');
