...
class Garp_Model_Spawn_Model_Set extends ArrayObject {
	...
	protected function _mirrorHasManyRelationsInOpposingModels(Garp_Model_Spawn_Model_Base $model) {
	...
	protected function _mirrorHasManyRelationsInModel(Garp_Model_Spawn_Model_Base $model, $relationName, Garp_Model_Spawn_Relation $relation) {
	...
	protected function _mirrorHabtmRelationsInOpposingModels(Garp_Model_Spawn_Model_Base $model) {
	...
	protected function _mirrorHabtmRelationsInModel(Garp_Model_Spawn_Model_Base $model, $relationName, Garp_Model_Spawn_Relation $relation) {
		$this->_throwErrorIfRelatedModelDoesNotExist($model, $relation);
	...
	protected function _throwErrorIfRelatedModelDoesNotExist(Garp_Model_Spawn_Model_Base $model, Garp_Model_Spawn_Relation $relation) {
