 ...
 * @subpackage Model
 */
class Garp_Model_Spawn_MySql_IndexKey extends Garp_Model_Spawn_MySql_Key {
	public $name;
	public $column;
	 ...
	 * @param Array $foreignKeys The foreignKeys in this table, of type Garp_Model_Spawn_MySql_ForeignKey.
