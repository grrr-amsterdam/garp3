 ...
 */
abstract class Garp_Model_Spawn_Config_Model_Abstract extends ArrayObject {
	...
	protected function _addModelLabel($id) {
		$defaults = array(
			'label' => ucfirst(Garp_Model_Spawn_Util::underscored2readable(
				Garp_Model_Spawn_Util::camelcased2underscored($this['id'])
			))
		);
