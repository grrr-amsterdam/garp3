...
class Garp_Model_Spawn_Config_Model_I18n extends ArrayObject {
	...
	public function __construct(Garp_Model_Spawn_Config_Model_Base $baseConfig) {
	 ...
	 */
	protected function _deriveI18nShadowModelConfig(Garp_Model_Spawn_Config_Model_Base $config) {
		$config = (array)$config;
