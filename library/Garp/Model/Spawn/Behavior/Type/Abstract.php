...
abstract class Garp_Model_Spawn_Behavior_Type_Abstract {
	...
	/**
	 * @param 	Garp_Model_Spawn_Model_Abstract 	$model 			Array or StdClass object with configuration parameters for the behavior
	 ...
	 */
	public function __construct(Garp_Model_Spawn_Model_Abstract $model, $origin, $name, $params = null, $type = null) {
		$this->setModel($model);
