 ...
 * @subpackage Spawn
 */
class Garp_Model_Spawn_Php_Model_BindingBase extends Garp_Model_Spawn_Php_Model_Abstract {
	/**
	 * @var 	Garp_Model_Spawn_Relation 		$_relation 	The accompanying HasAndBelongsToMany relation
	 */
	protected $_relation;

	/**
	 * @param	Garp_Model_Spawn_Model_Base		$model		The base model this habtm model is connected to
	 * @param	Garp_Model_Spawn_Relation		$relation	The accompanying HasAndBelongsToMany relation
	 */
	public function __construct(Garp_Model_Spawn_Model_Base $model, Garp_Model_Spawn_Relation $habtmRelation) {
	...
	/**
	 * @return Garp_Model_Spawn_Relation
	 */
	...
	/**
	 * @param Garp_Model_Spawn_Relation $relation
	 */
	...
	protected function _getRelationColumnName($modelId) {
		...
		$isHomophile 	= $this->_isHomophile();
		$column 		= Garp_Model_Spawn_Relation_Set::getRelationColumn($modelId, $this->_getModelPostFix($modelId));
	...
	protected function _getModelNamespace($modelId) {
		$modelNamespace = Garp_Model_Spawn_Util::camelcased2underscored($modelId);
