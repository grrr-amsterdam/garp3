...
class Garp_Adobe_InDesign_SpreadSet extends ArrayObject {
    ...
    /**
     * @return array    List of Story IDs, divided into pages, where 777 is the page index,
     *                  and a21 to a23 are Story IDs.
     *                  array(
     *                      777 => array(
     *                          a21, a22, a23
     *                      )
                    ...
                    if (array_key_exists('FillColor', $newAttribs)) {
                        ...
                        foreach ($pageStories as $storyId) {
                            ...
                            if (array_key_exists($tag, $fillColorsForThisRow)) {
                                $spread->setTextFrameAttribute(
                                    $storyId,
                                    'FillColor',
                                    $fillColorsForThisRow[$tag]
                                );
                            }
                        }
                    }
