...
class Garp_Adobe_InDesign {
	 ...
	 *									)
	 */
	public function dynamize($sourceFilename, $targetPath, array $newContent, $newAttribs = null) {
		$sourcePath 		= APPLICATION_PATH . '/data/idml/' . $sourceFilename;
